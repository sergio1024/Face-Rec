    ...
    public partial class FrmPrincipal : Form
    {
        ...
        private void button2_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show(textBox1.Text + "´rosto detetado e adicionado :)", "OK", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch
            {
                MessageBox.Show("Habilite a deteção primeiro", "Falha", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
